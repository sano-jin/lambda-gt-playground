module ForceExtra.QuadTree exposing (Config, QuadTree(..), Quadrant(..), UserCoords, empty, fromList, getAggregate, insertBy, performAggregate, quadrant, singleton, size, toList)
